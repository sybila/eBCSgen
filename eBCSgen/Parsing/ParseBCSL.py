        ...
        for i in range(len(search.children)):
            if self.get_name(struct) == self.get_name(search.children[i].children[0]):
                ...
                for j in range(len(struct.children[1].children)):
                    for k in range(len(search.children[i].children[0].children[1].children)):
                        if self.get_name(struct.children[1].children[j]) == self.get_name(search.children[i].children[0].children[1].children[k]):
                            struct_found = False
                            break
