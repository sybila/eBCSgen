...
class TestStructure(unittest.TestCase):
    ...
    def test_compatibility(self):
        ...
        self.assertTrue(objects.s17.compatible(objects.s15))
        self.assertFalse(
    ...
    def test_add_context(self):
        ...
        self.assertEqual(
            ...
            {(objects.s22, objects.s23), (objects.s24, objects.s25)},
        )
        self.assertEqual(
            objects.s20.add_context(1, atomic_signature, structure_signature),
            {(objects.s22, None), (objects.s24, None)},
        )
        self.assertEqual(
            objects.s20.add_context(-1, atomic_signature, structure_signature),
            {(None, objects.s22), (None, objects.s24)},
        )
    ...
    def test_replace(self):
        self.assertEqual(objects.s21.replace(objects.s22), objects.s23)
        self.assertEqual(objects.s26.replace(objects.s22), objects.s22)
